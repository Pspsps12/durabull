...
Production and self-hosted Durabull automatically collects anonymous/pseudonymous usage telemetry
to understand feature usage and improve the product. Durabull does not collect Redis URLs, queue
names, Redis key names, job data, logs, emails, names, organizations, or raw error messages.
